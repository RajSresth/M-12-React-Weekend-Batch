    ...
    const fetchProductData = async () => {
      try {
        ...
        const product = data?.products.find(
          (singleProduct) => singleProduct._id === params?.id,
        );
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            {product.image.map((imgSrc, idx) => (
              <div
                key={idx}
                className="w-20 h-20 bg-gray-100 rounded-lg overflow-hidden cursor-pointer border-2 border-transparent hover:border-orange-500 transition"
